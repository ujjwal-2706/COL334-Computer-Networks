...
void TearUpLink (Ptr<Node> nodeA, Ptr<Node> nodeB, uint32_t interfaceA, uint32_t interfaceB)
{
...
//  listRH.Add (staticRh, 5);
  ...
  // print the routing table at r1 to check if possible to reach destination
  // -----------------------Uncomment this if you want to check reachablity
  ...
  // routingHelper.PrintRoutingTableAt (Seconds(140.0),r1,routingStream);
  // routingHelper.PrintRoutingTableAt (Seconds(200.0),r1,routingStream);


  Simulator::Schedule (Seconds (50), &TearDownLink, r1, r2, 2, 1);
  Simulator::Schedule (Seconds (50), &TearDownLink, r1, r3, 3, 2);
  
  Simulator::Schedule (Seconds (120), &TearUpLink, r1, r2, 2, 1);
  Simulator::Schedule (Seconds (120), &TearUpLink, r1, r3, 3, 2);
